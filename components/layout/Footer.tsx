      ...
      <div className="mx-auto max-w-[1400px] px-6 md:px-10 py-12">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
          ...
          <div className="flex flex-wrap gap-10">
            <div>
              <p className="font-mono text-[10px] uppercase tracking-eyebrow text-white/25 mb-3">Navigation</p>
            ...
            <div>
              <p className="font-mono text-[10px] uppercase tracking-eyebrow text-white/25 mb-3">Contact</p>
            ...
            <div>
              <p className="font-mono text-[10px] uppercase tracking-eyebrow text-white/25 mb-3">Hours</p>
              ...
              <div className="flex gap-3 mt-4">
                {["LI", "IG", "FB"].map((s) => (
                  <a key={s} href="#" className="w-8 h-8 rounded-full glass flex items-center justify-center font-mono text-[10px] text-white/30 hover:text-white hover:bg-white/10 transition-all">
                    {s}
                  </a>
                ))}
              </div>
